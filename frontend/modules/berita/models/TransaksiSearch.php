...
use frontend\modules\berita\models\Transaksi;

/**
 * TransaksiSearch represents the model behind the search form about `frontend\modules\berita\models\Transaksi`.
 */
